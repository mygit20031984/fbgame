...
import pygame
from pygame.locals import * #Basics pygame imports
...
def mainGame():
    ...
    #Create 2 Pipes in blitting on the screen
...
def getRandomPipe():
    """
    Generate position of 2 pipes for blitting on the screen
    """
    pipeHeight = GAME_SPRITES['pipe'][0].get_height()
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('FlappyBird by ARYA')
    ...
    while True:
        welcomeScreen() #Shows Welcome screen until user presses the button
